...
#from useModelToConvert import unknownFunction


#this function will be replaced by the real one from Raph's python script
def unknownFunction(file):
